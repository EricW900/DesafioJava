...
public class HomeController {
    ...
    public String calcularMensalidade(@RequestParam("mensalidade") String mensalidadeStr,
                                      @RequestParam("tempo") String tempoStr, ModelMap model){ // Aqui ele pega o id "mensalidade" do HTML
        try {
            ...
            double valorTempo = mensalidade * tempo; // Cálculando em meses
            ...
            model.addAttribute("valorTempo", valorTempo);
